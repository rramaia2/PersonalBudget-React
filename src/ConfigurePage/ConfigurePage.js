...
function ConfigurePage({ updateHomePageData }) {
  ...
  useEffect(() => {
    const fetchAllCategories = async () => {
      try {
        const response = await axios.get('http://pbudget-4f755.web.app/api/get-all-categories');
  ...
  const handleAllocationSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://pbudget-4f755.web.app/api/configure-budget', budgetData);
  ...
  const handleDeallocationSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://pbudget-4f755.web.app/api/deallocation-budget', deallocateData);
      console.log(response.data);
